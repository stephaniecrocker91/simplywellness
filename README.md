...
Its target is to convince businesses to purchase these bespoke packages with the hopes of boosting employees productivity, morale, mental health and overall sense of wellbeing in the workplace.
...
3.  Insightful: why are these services beneficial to employees?
...
*   Contains aria-labels attached to links to make it user friendly and accessible.
...
*   It is fixed: always at the bottom of the page so as to be easily accessible to the user. It opens in a new tab with _blank.
...
*   Aria-labels on the social media links, to make it user friendly and accessible.
...
*   A header just below the navigation bar that clearly explains the purpose of the site: Workplace Wellbeing & Mental health. Its colors contrast the header.
...
This was the image that inspired the colors for my website. I wanted to work with warm, earthy tones that contribute to the sites purpose. I added a few greens in the images, to give it more vibrancy.

I then picked the following colors to be used in different elements on the site: font color and background-color.
...
*   Letter-spacing: To create more sense of space I added 1px letter spacing as default body styling, and 4px for the headers.
*   Font-style: I played around with Uppercase styling (for headers) and Italics (for some paragraphs) to add a sense of dynamics to the site.
...
*   Social Media links: Facebook, Instagram, Linekdln
...
1.  For this error, I removed the div, and created an unordered list containing the services names and the hyperlinks in them. I then styled with CSS. List-style none, text-align centre, and margin top 1rem. I re-tested and there was still an error: the h3 wrapped around the ul. Removed this and then had to restyle CSS again.
2.  Same as above.
...
1.  Added a h3 to the form section for semantic clarity.
...
2.  Wrong syntax: Removed the unnecessary coma.
3.  Wrong syntax: Removed the unnecessary coma.
...
* The checkboxes in the form are optional as intended. Form can be submitted without them, as long as text input fields are filled out.
...
#### Lighthouse testing
* Initially, with the lighthouse testing the performance read 57%. I asked the tutors at code Institute, and they mentioned that reducing my Hero Image would help. 
...
3.  Insightful: why are these services beneficial to my employees?
    *   Home page sub header describes immediate the benefits of these wellness services: Boost productivity & wellbeing.
...
4.  Educational: I want to learn something about the services after reading the content of this site.
    *   The Our Services section goes into details about each service: content, health and psychological benefits and structure.
...
* Services educational content:
    ...
    * [HIIT Website: for benefits of HIIT](https://www.healthline.com/nutrition/benefits-of-hiit#TOC\_TITLE\_HDR\_6)
...
* Images & Icons:
    * [Font Awesome](https://fontawesome.com/) for social media anchor links.
        ...
        *   [Likedln Icon](https://fontawesome.com/v5.15/icons?d=gallery&p=2&q=linkedin)
